...
# python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --dir_demo super_resolution/EDSR-PyTorch/test --reset
...
python main.py --data_test Demo --scale 2 --pre_train download --test_only --save_results True
